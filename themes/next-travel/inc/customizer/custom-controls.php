 ...
 */
class Next_Travel_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Next_Travel_Dropdown_Category_Control extends WP_Customize_Control {
...
class Next_Travel_Note_Control extends WP_Customize_Control {
...
class Next_Travel_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Next_Travel_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="next-travel-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Next_Travel_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Next_Travel_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="next-travel-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="next-travel-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu next-travel-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="next-travel-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
Class Next_Travel_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
...
class Next_Travel_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="next-travel-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'next-travel' ); ?>" class="next-travel-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
 ...
 * @since  1.0.0
 */
class Next_Travel_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Next_Travel_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';

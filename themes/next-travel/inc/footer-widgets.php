...
class Next_Travel_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'next_travel';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'next-travel' ), $i ),
...
// Initialize.
$next_travel_footer_widgets = new Next_Travel_Footer_Widgets();
